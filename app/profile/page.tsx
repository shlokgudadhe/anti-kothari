...
export default async function Profile(){
  ...
  <section className="panel add-person"><h2>Change name</h2><form className="form" action={updateMyName}><label>Name<input type="text" name="name" defaultValue={user.full_name||""} placeholder="Your name" required/></label><SubmitButton pendingLabel="Saving…">Save</SubmitButton></form></section>
